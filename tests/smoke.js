...
assert.equal(window.__FENGYUN_GAME__.snapshot().fighter.firepowerMultiplier, 2);
window.__FENGYUN_GAME__.activateAmplifier();
...
assert.equal(window.__FENGYUN_GAME__.snapshot().fighter.firepowerMultiplier, 1);
